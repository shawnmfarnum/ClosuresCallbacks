var add, subtract, multiply, divide, calculate, reverseOrder, someFunc, counterup, counter
// Callbacks
...
// Create a function called userHelp that takes in a callback function and prompts the user to provide their favorite quote. Then, invoke the callback function using the provided string. Return the result of the callback.
...
// When you are done, we can invoke the otherFunc function and pass in another number value as its argument. And we can do this as often as we like.
...
// Then whenever you need to count up, you can invoke the counter function.
